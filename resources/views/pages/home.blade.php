...
@section('content')
    ...
    <main>
        ...
        <secttion class="section-popular-content" id="popularContent">
            <div class="container">
        ...
        <section class="section-networks" id="networks" class="container row">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h2>Our Networks</h2>
                    ...
                    <div class="col-md-8 text-center">
                        <img src=" {{ url('frontend/images/partner.png') }} " alt="partners" class="img-partner">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                ...
                                <p class="testimonial">
                                    "It was glorious and I could not stop to say woohooo for every single moment"
                                </p>
                            </div>
                            <hr>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            ...
                            <hr>
                            <p class="trip-to mt-2">Sabrina</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
