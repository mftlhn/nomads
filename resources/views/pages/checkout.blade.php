            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <input type="text" style="width: 50px" name="nationality" id="nationality" placeholder="Nationality"
                                    class="form-control mb-2 mr-sm-2">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="text-center mt-3">
                        <a href=" {{ route('detail', $item->travel_package->slug) }} " class="btn btn-block btn-cancel-join text-muted">Cancel Booking</a>
                    </div>
                </div>
            </div>
        </div>
