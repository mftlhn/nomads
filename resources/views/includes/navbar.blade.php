        ...
        <div class="collapse navbar-collapse" id="navb">
            ...
            @auth
                ...
                <form class="form-inline d-sm-block d-md-none"  action=" {{ url('logout') }} " method="POST">
                    @csrf
                    <button class="btn btn-login my-2 my-sm-0" type="submit" type="submit">Keluar</button>
                </form>
                <!-- Mobile button -->
                ...
                <form class="form-inline my-2 my-lg-0 d-none d-md-block" action=" {{ url('logout') }} " method="POST">
                    @csrf
                    <button class="btn btn-login btn-navbar-right my-2 my-sm-0 px-4" type="submit" type="submit">Keluar</button>
                </form>
                <!-- Desktop button -->    
            @endauth
